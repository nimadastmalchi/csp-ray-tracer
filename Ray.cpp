...
void printRays(vector<Ray>& missPanel, vector<Ray>& hitPanel, vector<Ray>& missCollector, vector<Ray>& hitCollector) {
    ...
    ofstream missPanelFile("Data/~miss_panel.txt");
    int increment = 0;
